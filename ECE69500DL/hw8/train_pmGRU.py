...
if __name__ == '__main__':
    ...
    run_code_for_training_for_text_classification_with_GRU_word2vec(epochs=5, device=device, learning_rate =  1e-4,
                                                                    ...
                                                                    path_saved_model = "./saved_pmGRU1e-4", net=model, display_train_loss=True)

    ## TESTING:
    print("\nStarting testing\n")
    validation.run_code_for_testing_text_classification_with_GRU_word2vec(path_saved_model = "./saved_pmGRU1e-4", test_dataloader = test_dataloader, net=model)